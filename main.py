...
class MainApp(App):
    ...
    def show_res(self, res, *args):
        ...
        if res == 'you':
            self.board.text= 'congrats you won'.upper()
            self.board.color= [0,1,0,1]# green
            self.board.szz= '20sp'

        elif res == 'foe':
            self.board.text= 'sorry you lost'.upper()
            self.board.color= [1,0,0,1]
            self.board.szz= '20sp'

        elif res == 'tie':
            self.board.text= 'its a tie'.upper()
            self.board.color= [0,0,0,1]
            self.board.szz= '20sp'
        self.you= ''
        self.opp= ''
